...
- 本目录入口：`README.md`
- 插件 1 规范：`../RetinarBatchBuilder_Share/PACKAGING_RULES.md`（规则 33–40、贴图两遍、顶点色保留）
- 插件 1 变更：`../RetinarBatchBuilder_Share/CHANGELOG.md`（v1.2.8 贴图覆盖保护、v1.2.9 顶点色保留）
- 插件 1 手册：`../RetinarBatchBuilder_Share/RetinarBatchBuilder_分享说明.md` §6.1

本文只描述插件 2；打包产物目录与交付校验以插件 1 文档为准。
