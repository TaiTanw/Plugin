...
2026-09-16：④ 步骤 **1–14 已落地**（含 leftover **41**、贴图身份 **42**）。内核未迁目录。含这些改动的工作区**尚未提交**。上次文档核对的 `main` 基线仍是 **e51469a**（2026-09-14）。**v1.5.3**（`8131b31`）是历史发布标签。

操作者流程：[插件根 README](../../../README.md)。`feature/cli-pipeline-2022` 已合入 **main**。D5 契约见 [cli-getting-started](../04_implementation/cli-getting-started.md)（现含 41/42）。AB 文件名见 [§2](#2-issue-274)（未改代码）。
...
| 日期 | 哈希 | 说明 |
|---|---|---|
| 2026-09-16 | （文档+代码，未提交） | ④ 步骤 1–14：41 leftover / 42 身份报错但不卡；操作者流程收到插件根 README |
